...
- Opening a [private security advisory](https://github.com/roarkhq/sdk-roark-analytics-python-livekit/security/advisories/new) on this repository, **or**
...
This policy covers the `roark-analytics-python-livekit` package published from this repository. For vulnerabilities in the Roark Analytics platform itself, please email security@roark.ai directly.
